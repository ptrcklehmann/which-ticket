        ...
        <div className='step is-active'>
            <div className="results">
                <p>
                    ...
                    {(data.bike.present === 'true') && ` and you are bringing ${data.bike.amount} ${(Number(data.bike.amount) > 0) ? `bikes` : `bike`} with you.`}
                </p>
                <p>
                    The best ticket option is:<br /><strong>{ticket.title}</strong><br />
